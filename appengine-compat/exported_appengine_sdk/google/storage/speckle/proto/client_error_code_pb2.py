...
_SQLSERVICECLIENTERROR_CLIENTERRORCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_BACKEND_ADDRESS_LOOKUP_FAILED', index=39, number=1050,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_BACKEND_NOT_REACHABLE', index=40, number=1051,
      options=None,
      type=None),
  ],
